...
var InvalidPLZ = Error('Invalid Postalcode'); // Invalid PLZ Err
var WrongFormatError = Error('Wrong param provided'); // Invalid Format Err
var ParamMissing = Error('Param is missing'); // Param missing err
